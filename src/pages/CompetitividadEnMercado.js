...
import OfertasPorCampoTreemap from '../components/OfertasPorCampoTreemap';
import EstudiantesPorOfertaChart from '../components/EstudiantesPorOfertaChart';
import { getVistaPanoramicaMetrics } from '../services/crecimientoProfesionalService';

const CompetitividadEnMercado = () => {
  ...
  useEffect(() => {
    const loadMetrics = async () => {
      try {
        ...
        console.error('Error cargando métricas de competitividad:', err);
    ...
    return (
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-semibold text-gray-900">Competitividad en el Mercado</h1>
            <p className="mt-1 text-sm text-gray-500">
              Análisis de la competitividad de nuestros estudiantes en el mercado laboral
            </p>
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Análisis de Competencias - Fila completa */}
      <CompetenciasAgrupadasChart />

      {/* Distribución de Ofertas Laborales - Fila completa */}
      <OfertasPorCampoTreemap />
...
export default CompetitividadEnMercado;
